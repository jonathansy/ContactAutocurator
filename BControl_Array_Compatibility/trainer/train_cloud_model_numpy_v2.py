...
def train_model(data_dir, export_dir, m_name):
    ...
    current_validation = 'gs://whisker-autocurator-data/Data/Standard_Train/Valid_Data_1_Session_1.npy'
    # Load initial validation data
    x_test = load_image_data(current_validation)
    x_test = x_test.reshape(x_test.shape[0], img_rows, img_cols, 1)
    valid_labels = current_validation[0:50] + 'Valid_Labels_' + current_validation[61:]
    y_test = load_image_labels(valid_labels, num_classes)
    batch_num = 1
    for np_file in datasets:
        if np_file[56:62] == 'Labels':
            continue
        elif np_file[50:55] == 'Valid':
            if np_file != current_validation:
                ...
                valid_labels_new = current_validation[0:50] + 'Valid_Labels_' + current_validation[61:]
            ...
            if batch_num == 1:
                ...
                np_labels = np_file[0:50] + 'Train_Labels_' + np_file[61:]
