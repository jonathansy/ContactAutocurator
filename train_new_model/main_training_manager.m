...
trainCodePath = 'C:\SuperUser\Documents\GitHub\whisker-autocurator\Autocurator_Beta\trainer';
gcloudBucket = 'gs://whisker-autocurator-data';
gcloudProjectID = 'whisker-autocurator';
runVer = 1.8;
modCode = 'trainer.train_cloud_model_numpy_JK';
modCodePath = 'trainer';
region = 'us-east1';
configFile = 'C:\Users\shires\AppData\Local\Google\Cloud_SDK\trainer\cloudml-gpu.yaml';
dataBucket = [gcloudBucket '/Data/JK_Train'];
